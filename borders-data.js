...
window.BORDERS = (function () {
  ...
  const CROSSINGS = [
    ...
    {
      id: "kelebija", mapPBin: [46.172760, 19.554454, 46.163229, 19.563629], mapPB: [46.1642685, 19.5626338, 46.1704754, 19.5563793], mapRoute: ["Granični prelaz Kelebija", "Tompa határátkelőhely"], coords: [46.191, 19.541], name: "Kelebija", from: "RS", to: "HU",
